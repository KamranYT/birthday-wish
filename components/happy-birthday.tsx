...
const candleColors = ['#FF6B6B', '#FFD93D', '#9DFF00', '#69B1FF', '#FF84E8']
const balloonColors = ['#FF6B6B', '#FFD93D', '#9DFF00', '#69B1FF', '#FF84E8']
...
export default function BirthdayWish() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 flex items-center justify-center p-4">
      ...
      >
        {/* Birthday card */}
        <Card className="bg-white shadow-xl rounded-lg border-4 border-gray-300 mx-auto transition-transform transform hover:scale-105">
          {/* Card header with birthday message */}
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-pink-400">Happy 20th Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-red-400 ">Muhammad Kamran</CardDescription>
            <p className="text-lg text-red-300">September 4th</p>
          </CardHeader>
          ...
          <CardFooter className="flex justify-center">
            <Button 
              className="bg-gradient-to-r from-green-400 to-blue-500 text-white hover:from-blue-500 hover:to-green-400 transition-all duration-300"
              onClick={celebrate}
